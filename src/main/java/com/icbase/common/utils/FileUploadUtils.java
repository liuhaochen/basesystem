package com.icbase.common.utils;
...
import com.icbase.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
    ...
    // 默认上传的地址
    private static String defaultBaseDir = IcBaseConfig.getProfile();
