package com.icbase.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;

import com.icbase.common.constant.CommonMap;
...
import com.icbase.framework.config.GenConfig;
import com.icbase.project.tool.gen.domain.ColumnInfo;
import com.icbase.project.tool.gen.domain.TableInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/icbase/fawuto";

    /** mybatis空间路径 */
    private static final String myBatisPath = "main/resources/mybatis/fawuto";

    /** html空间路径 */
    private static final String templatesPath = "main/resources/templates/fawuto";

    /** js空间路径 */
    private static final String javascriptPath = "main/resources/static/icbase/fawuto";
    ...
    {
        System.out.println(StringUtils.convertToCamelCase("FWT_USER_WEIXIN"));
        System.out.println(replaceKeyword("用户微信扩展信息"));
        System.out.println(getModuleName("com.icbase.project.fawuto"));
    }
}
